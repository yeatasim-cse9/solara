...
export const WovenCanvas = () => {
  ...
  return <div ref={mountRef} className="absolute inset-x-0 top-1/2 -translate-y-1/2 h-full z-0 pointer-events-auto flex items-center justify-center overflow-hidden" />;
};
